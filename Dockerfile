FROM ubuntu:14.04
MAINTAINER Austin Williams <rawebtechstack@gmail.com>
...
RUN apt-get install -y --force-yes php7.3-fpm php7.3-cli php7.3-dev php7.3-pgsql php7.3-sqlite3 php7.3-gd \
    ...
    php7.3-imagick php7.3-mbstring php7.3-xml php7.3-zip
RUN sed -i "s/error_reporting = .*/error_reporting = E_ALL/" /etc/php/7.3/cli/php.ini && \
    ...
    sed -i "s/;extension=php_soap.dll*/extension=imagick.so/" /etc/php/7.3/fpm/php.ini && \
